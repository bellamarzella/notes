...
In short, this adds an *unpredictable request parameter*, which as we mentioned the absence of which is a requirement for CSRF attacks. See [[bypassing-token-validation]] for common flaws and exploitation methods.
#### SameSite Cookies
